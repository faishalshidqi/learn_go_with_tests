...
func (s *StubPlayerStore) GetLeague(order bool) src.League {
	return s.league
}
...
func assertLeague(t *testing.T, got, wantedLeague []src.Player) {
	t.Helper()
...
func getLeagueFromResponse(t testing.TB, body io.Reader) (league []src.Player) {
	league, _ = src.NewLeague(body)
	return
}
